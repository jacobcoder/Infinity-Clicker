...
function normNumClick(){
    mainNumber = mainNumber + (1*normNumMult)^normNumPower
...
function numClickMultClick(){
    ...
    document.getElementById("numClickMult").innerHTML = "Your number gain is multiplied by "+normNumMult+"."
}
//stage 1.2: Number Click Power Increments
function numClickPowClick(){
    normNumPower = normNumPower + 1
    document.getElementById("numClickPower").inner.html = "Your number is being exponentiated by "+normNumPower+"."
}
